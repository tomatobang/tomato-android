package com.tomatobang.tomatoandroid.server.network.http;
...
public class SyncHttpClient {
    ...
    public SyncHttpClient(SchemeRegistry schemeRegistry) {
        ...
        HttpProtocolParams.setUserAgent(httpParams, "TomatoBang v1.0 (Android; targetsdkversion " + Build.VERSION.SDK_INT + ";)");
