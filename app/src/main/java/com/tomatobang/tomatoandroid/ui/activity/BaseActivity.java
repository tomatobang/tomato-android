...
import com.tomatobang.tomatoandroid.server.TomatoAction;
import com.tomatobang.tomatoandroid.server.network.async.AsyncTaskManager;
import com.tomatobang.tomatoandroid.server.network.async.OnDataListener;
import com.tomatobang.tomatoandroid.server.network.http.HttpException;
import com.tomatobang.tomatoandroid.server.utils.NToast;

public abstract class BaseActivity extends FragmentActivity implements OnDataListener {

    protected Context mContext;
    public AsyncTaskManager mAsyncTaskManager;
    protected TomatoAction action;
...
//                mBtnBackDrawable.getMinimumHeight());
        ...
        // Activity管理
        action = new TomatoAction(mContext);
